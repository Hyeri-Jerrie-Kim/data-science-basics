# -*- coding: utf-8 -*-
"""Hyeri_Kim_matplotlib.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1MQIHva85HEUAZBqaZOIOggIF1az1cECy
...
x holds 1000 values between -5 and 5
...
plt.plot(x, y)
plt.title("Polynomial_Hyeri")
plt.xlabel("x")
plt.ylabel("y = x**2 + z**3 + 6")
plt.grid(True)
plt.show()
...
On the forth row plot one function^7 spanning all columns in dotted red.
"""
...
plt.plot(x, x**3, 'y-')
plt.subplot2grid((4,4), (1, 1), rowspan=1, colspan = 3)
plt.plot(x, x**4, 'r-')
...
plt.text(px - 0.08, py, "New point_Hyeri", ha="right", weight="heavy")
plt.text(px, py, "x = %0.2f\ny = %0.2f"%(px, py), rotation=50, color='gray')
...
scale = randint(3, 100, size = 300)

plt.scatter(x, y, s=scale, alpha = 0.35, color = 'magenta', edgecolor = 'white')
plt.grid(True)
plt.title("Scatter_Hyeri")
plt.xlabel("x")
plt.ylabel("y")
plt.show()
...
"""Play around with values and colors of the second graph"""

data1 = np.random.randn(400)
data2 = np.random.randn(500) + 2
data3 = np.random.randn(450) + 7
data4a = np.random.randn(200) + 9
data4b = np.random.randn(200) + 12

plt.hist(data1, color='brown', histtype='step', label='step hist')
plt.hist(data2, bins=8, color='gray', alpha=0.6, label='bar hist') # default histtype='bar'
plt.hist(data3, color='yellow', alpha=0.55, histtype='stepfilled', label='stepfilled hist')
plt.hist((data4a, data4b), color=('green','blue'), alpha=0.35, histtype='barstacked', label=('barstacked a', 'barstacked b'))
