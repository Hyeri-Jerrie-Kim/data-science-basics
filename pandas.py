# -*- coding: utf-8 -*-
"""Hyeri_Kim_pandas.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11OB1zMKiuJZTlllVs7Xejh1lmi8P_EET
...
hyeri_fruits = {"apple": "red", "banana": "yellow", "kiwi": "green", "cherry": "dark red"}
...
hyeri_amounts = [10, 23, 24, 30]
hyeri_date = pd.date_range("2023/2/5 2:00pm", periods=4, freq='H')

hyeri_rainfall_amount_today = pd.Series(hyeri_amounts, hyeri_date)
hyeri_rainfall_amount_today

hyeri_rainfall_amount_today.plot(kind = "bar")
...
1. Add a column named education and fill in ‘Diploma” for alice, and ‘Masters’ for bob
2. Print out everything related to alice.
"""

hyeri_people = people
hyeri_people["education"] = pd.Series({"alice":"Diploma", "bob": "Masters"})
hyeri_people.loc["alice"]

hyeri_people.iloc[0:1]        # display it again as a dataFrame
...
hyeri_grades_array = np.array([[60, 80, 90, 100],[50, 70, 90, 60],[100, 90, 100, 100], [90, 70, 80, 100]])
hyeri_grades = pd.DataFrame(hyeri_grades_array, columns=["Apr", "May", "Jun", "Jul"], index=["amy", "smith", "chloe", "jennie"])
hyeri_grades

"""1. Print out the average for the month of April"""

avg_by_month = hyeri_grades.mean()
avg_by_month.loc["Apr"]
...
hyeri_grades_pass_or_fail = hyeri_grades.copy()

avg_grade = hyeri_grades_pass_or_fail.mean(axis=1)
fail = (avg_grade < 50)

hyeri_grades_pass_or_fail

hyeri_grades_pass_or_fail["Average"] = avg_grade
hyeri_grades_pass_or_fail

hyeri_grades_pass_or_fail["Fail"] = fail
hyeri_grades_pass_or_fail
